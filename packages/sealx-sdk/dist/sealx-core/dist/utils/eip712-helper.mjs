...
const layoutRender = (template$1, context) => {
    const render = template(template$1);
    return render(context);
};

export { buildSignRenderContext, checkTemplateArgValid, convertToISOFormat, layoutRender, parseSignContent };
//# sourceMappingURL=eip712-helper.mjs.map
