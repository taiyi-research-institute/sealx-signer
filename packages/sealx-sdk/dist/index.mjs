...
export { SealxProvider, bindSealx, checkSealx, closeSealx, connectSealx, initSealx, isSealxActive, isSessionAvailable, onSign, remoteSign, sealxActive, sendSignResponse, signBySealx, wait };
